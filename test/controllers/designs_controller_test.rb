...
class DesignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post designs_url, params: { design: { image: @design.image, price: @design.price, title: @design.title, user_id: @design.user_id } }
    end
  ...
  test "should update design" do
    patch design_url(@design), params: { design: { image: @design.image, price: @design.price, title: @design.title, user_id: @design.user_id } }
